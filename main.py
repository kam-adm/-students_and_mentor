...
best_student = Student('Макс', 'Барский', 'Муж')
best_student.courses_in_progress += ['Python']
best_student.courses_in_progress += ['Java']
best_student.add_courses('C++')

bad_student = Student('Иван', 'Иванов', 'Муж')
...
cool_reviewer = Reviewer("Пётр", "Белов")
cool_reviewer.courses_attached += ['Python']
cool_reviewer.courses_attached += ['Java']
...
cool_lecturer = Lecturer('Сергей', 'Рыбалкин')
cool_lecturer.courses_attached += ['Python']
lecturers_list.append(cool_lecturer)

def_lecturer = Lecturer('Ян', 'Полуян')
